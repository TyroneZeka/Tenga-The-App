...
class ProductMeta(models.Model):
    ...
    weight = models.FloatField(
        unique=False, null=True, blank=True, verbose_name=_("product weight")
    )
    created_at = models.DateTimeField(
        auto_now_add=True,
        editable=False,
...
class Media(models.Model):
    ...
    product = models.ForeignKey(
        Product, on_delete=models.PROTECT, related_name="media_product"
    )
...
class Stock(models.Model):
    product_meta = models.OneToOneField(
        ProductMeta, related_name="product_meta", on_delete=models.PROTECT
    )
